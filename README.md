...
- 🧠 [**StressGuard**](https://github.com/zohaybhassan/StressGuard-ML-Based-Stress-Detection) — ML-based stress detection with wearable telemetry, an Android dashboard, and real-time interventions.
- ✉️ [**Mail-Gen**](https://github.com/zohaybhassan/Mail-Gen-AI-Powered-Agentic-Email-Generator-Scheduler) — an AI-powered agentic email generator and scheduler.
- 🤝 [**SyncSpace**](https://github.com/zohaybhassan/SyncSpace) — a modern full-stack collaboration project.
- 🌐 [**Portfolio**](https://github.com/zohaybhassan/Portfolio) — my personal portfolio built with TypeScript.
...
<img src="https://skillicons.dev/icons?i=kotlin,androidstudio,html,css,bootstrap,js,ts,react,vue,nodejs,java,cpp&perline=12" alt="Full-stack and mobile technologies" />
...
📍 Islamabad, Pakistan &nbsp;•&nbsp; Open to building useful AI, software, and analytics solutions
